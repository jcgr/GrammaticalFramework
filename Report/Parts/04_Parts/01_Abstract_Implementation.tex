...
In this section, the dierent parts of the abstract syntax will explained individually, but the full abstract implementation can be found in appendix \note{A_01} if the reader wants to look at it.
...
The \cf{InequalityOperation} and \cf{ArithmeticOperation} represents the dierent inequality- and arithmetic op-erations and should require no explanation
